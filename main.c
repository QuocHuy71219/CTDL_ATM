...
start:    
	...
	printf("\t\t |                                          | \n"); 
	printf("\t\t |                                          | \n");      
	printf("\t\t |    1. Khoi tao he thong                  | \n");
	printf("\t\t |                                          | \n");
	printf("\t\t |    2. Hien thi nhat ky giao dich ATM     | \n");
	printf("\t\t |                                          | \n");    
	printf("\t\t |    3. Menu giao dich cua nguoi dung      | \n");  
	printf("\t\t |                                          | \n");
	printf("\t\t |    4. Thoat                              | \n");
	printf("\t\t --------------------------------------------\n\n");
     ...
     for (i=0; i <= 20;i++) {
	    ...
	    if (newdata != NULL)
	    {
	       ...
	       if (search_client(header,nuserid) == 1)
	        {
	            system("cls");
	            printf("\tERROR: Tai khoan khach hang da ton tai\n");
	            printf("\t-------------------------------------------------\n");
	            goto start;
	        }else{
	...
	{
	printf("Nguoi dung da dang nhap: %d\n\n",loginid);
    ...
    case 4:
        ...
        break;
    default:
        printf("Chi chon cac tuy chon duoc liet ke\n");
    }
...
void userlogin ()
{
    ...
    {
        printf("Tai khoan khong hop le !Vui lòng thu lai\n");
        //Try 2
        while (attempts<=1)
        {
            printf("Nhap pin:\n");
            ...
            {
                attempts+= 1;
                printf("Du lieu khong hop le hoac tai khoan bi khoa!Vui long thu lai\a\n");
            }
            ...
            else if (login(header,headerh,loginid,pin,cash) == 2)
            {
                ...
                printf("khong hop le hoac tai khoan bi khoa!Vui long thu lai\n");
        }
    }
    else printf("So tai khoan khong hop le!Vui long thu lai\n");
    //Try 3
    if (attempts==2)
    {
        l = header->next;
...
void menu(ulist header,hlist headerh,int login,int pin,atm cash)
{
    ...
    printf("\t\t |                                             | \n");
    printf("\t\t |          4. Xem danh sach tai khoan         | \n");
    printf("\t\t |                                             | \n");
    printf("\t\t |          5. Hien thi nhat ky giao dich ATM  | \n");
    printf("\t\t |                                             | \n");
    printf("\t\t |          6. Hien thi tien trong ATM         | \n");
    printf("\t\t |                                             | \n");
    printf("\t\t |          0. Thoat                           | \n");
    printf("\t\t -----------------------------------------------\n\n");
    ...
    case 4:
        ...
        printf("\t\t -----------------------------------------\n");
        printf("\t\t ::                                    :: \n");
        printf("\t\t ::    Xem danh sach tai khoan         :: \n");
        printf("\t\t ::                                    :: \n");
        printf("\t\t -----------------------------------------\n");
    ...
    case 5:
        ...
        printf("\t\t -----------------------------------------\n");
        printf("\t\t ::                                    :: \n");
        printf("\t\t ::    Hien thi nhat ky giao dich ATM  :: \n");
        printf("\t\t ::                                    :: \n");
        printf("\t\t -----------------------------------------\n");
    ...
    case 6:
        ...
        printf("\t\t -----------------------------------------\n");
        printf("\t\t ::                                    :: \n");
        printf("\t\t ::    Hien thi tien trong ATM         :: \n");
        printf("\t\t ::                                    :: \n");
        printf("\t\t -----------------------------------------\n");
...
void menu2(ulist header,hlist headerh,int login, int pin,atm cash)
{
	...
	printf("\t\t |                                                | \n");
	printf("\t\t |          4. Xem thong tin tai khoan            | \n");
	printf("\t\t |                                                | \n");
	printf("\t\t |          5. Xem noi dung giao dich             | \n");
	printf("\t\t |                                                | \n");
	printf("\t\t |          6. Doi ma pin                         | \n");
	printf("\t\t |                                                | \n");
	printf("\t\t |                                                | \n");
    ...
    case 4:        
        ...
        printf("\t\t ---------------------------------------- \n");
        printf("\t\t ::                                    :: \n");
        printf("\t\t ::      Xem thong tin tai khoan       :: \n");
        printf("\t\t ::                                    :: \n");
        printf("\t\t ---------------------------------------- \n");
...
start:
    do
    {
        ...
        if (search_client(header,nuserid) == 1)
        {
            printf("\tTai khoan da ton tai. Vui long nhap mot Tai khoan khac \n"); 
            goto start;
        }
        printf("Nhap pin (4 digits): \n");
        INPUT scanf("%4d",&npin);
	...
	printf("Nhap so du: \n");
        ...
        printf("Nhap trang thai ban dau cua nguoi dung: \n");
        printf("0 Active\t1 Blocked\t\t");
        INPUT scanf("%d",&nstate);
        
        printf("1 luu&thoat\t\t0 sua\n");
        INPUT scanf("%d",&conf);
...
void delete_client(ulist header,hlist headerh,int login, int pin,atm cash)
{
    ...
    printf("Nhap ID cua khach hang ban muon xoa\n");
    INPUT scanf("%d",&key);
    ...
    while (users->next != NULL)
    {
        ...
        if ((users->userid) == key)
        {
            ...
            printf("%s\n" ,__TIME__);
            printf("tai khoan no. %d xoa thanh cong\n",key);
...
int unlock_client(ulist header,hlist headerh,int login, int pin,atm cash) 
{
   ...
   //Loops through out the values of nodes and is a vector
    ...
    printf("Nhap tai khoan ban muon mo khoa\n");
    INPUT
    scanf("%d",&key);
    //Loops through out the values from the clients structure
    while (l)
    {
        ...
        {
            l->state = 0;
            printf("Client %d mo khoa thanh cong\n",key);
 ...
 //gets structures ulist values and assign a variable l
  ...
  //Loops through out the values from the clients structure     
    ...
    {   //checks if user is true
	    ...
	    printf("Phi $%6.2f da khau tru\n\n",fee);
            printf("So du cua ban bay gio $%6.2f\n",d->sum);        
...
start:
    printf("Nhap so tai khoan de chuyen tien\n");
    INPUT
    scanf("%d",&uid);
    ...
    {   
        ...
        {   //checks if user is true
            if (l->userid == login)
            {
                printf("Cho biet so tien ban muon chuyen\n");
                INPUT
                scanf("%f",&value);
                if (value<=(l->sum))
                {
		   ...
		   //substract transfer value from login account 
                    ...
                    { //checks if user is true
                        ...
                        { 
                            ...
                            printf("%s\n\n" ,__TIME__);
                            printf("Phi $%6.2f da khau tru\n\n",fee);
                            printf("Da chuyen $%6.2f \ntu so tai khoan no. %d den so tai khoan no. %d\n\n",value,l->userid,j->userid);       
			    printf("So du hien tai cua ban la $%6.2f\n",l->sum);                     
                    ...
                    printf("Khong có du tien trong tai khoan cua ban\n");
                    printf("Ban chi co $%6.2f trong tai khoan\n",l->sum);
                }
    ...
    {
        printf("Xin loi, khong duoc phep. Hay thu mot tai khoan khac. Ðay la cua ban\n\n");
        goto start;
    
	}else
        printf("Tai khoan %d khong ton tai trong danh sach \n",uid);
    LINE
...
void cust_withdraw(ulist header,hlist headerh, int login, int pin, atm cash)
{
    ...
    do
    {
        printf("Cho biet so tien ban muon rut\n");
        INPUT 
        scanf("%f",&value);
        if (value>max) printf("The maximum tien rut is $%6.2f\n\n",max);
        else if (value<min) printf("The minimum tien rut is $%6.2f\n\n",min); 
    ...
    while (l)
    {
		...
		if(cash.money>=value){
			...
			l->sum-=total;
		        ...
		        printf("%s\n\n" ,__TIME__);
		        printf("Phi $%6.2f da khau tru\n\n",fee);
		        printf("Ban hien tai co $%6.2f trong tai khoan\n",l->sum);
		...
		printf("Khong du tien trong ATM tai thoi diem hien tai!\n");
		printf("Chi co $%6.2f kha dung de rut tien\n\n",cash.money);
		option1(header,headerh,login,pin,cash);	
            }
        }
        l=l->next;
...
void write_vaultdb(atm cash)
{
    FILE *f_cash = fopen("tienATM.txt", "w");
...
atm read_vaultdb()
{
    ...
    FILE *f_cash = fopen("tienATM.txt", "r");
    if (f_cash == NULL)
    {
        FILE *f_cash = fopen("tienATM.txt", "w");
...
void read_custdb(ulist header)
{
    ...
    FILE *f_clients= fopen("admin_user.txt", "r"); 
...
{
    ulist l=header->next;
    FILE *f_clients = fopen("admin_user.txt", "w");
...
void read_logdb(hlist headerh)
{
    ...
    FILE *f_hist = fopen("lichsu.txt", "r");
    if (f_hist == NULL)
    {
        FILE *f_hist = fopen("lichsu.txt", "w");
    }
    else
    {
